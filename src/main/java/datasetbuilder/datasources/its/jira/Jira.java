...
public class Jira implements IssueTrackingSystem {
    ...
    @Override
    public List<Issue> getIssues(String projectName, Map<Integer, Release> releasesByVersionID) {
        ...
        do {
            ...
            String url = "https://issues.apache.org/jira/rest/api/2/search?jql=project=%22"
                    ...
                    + "%22status%22=%22resolved%22)AND%22resolution%22=%22fixed%22&fields=key,fixVersions,versions,created,resolutiondate&startAt="
                    + i + "&maxResults=" + j;
    ...
    private Issue createIssueFromJSON(JSONObject input) {
        ...
        if (fixedVersionsIDs.length != 0)
            output = new Issue(key, Utils.stringArrayToIntArray(affectedVersionsIDs), Utils.stringArrayToIntArray(fixedVersionsIDs), creationDate, resolutionDate);
